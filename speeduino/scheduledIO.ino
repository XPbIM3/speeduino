...
inline void beginCoil1Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil1Charging_DIRECT(); } else { coil1Charging_MC33810(); } tachoOutputFlag = READY; }
...
inline void beginCoil2Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil2Charging_DIRECT(); } else { coil2Charging_MC33810(); } tachoOutputFlag = READY; }
...
inline void beginCoil3Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil3Charging_DIRECT(); } else { coil3Charging_MC33810(); } tachoOutputFlag = READY; }
...
inline void beginCoil4Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil4Charging_DIRECT(); } else { coil4Charging_MC33810(); } tachoOutputFlag = READY; }
...
inline void beginCoil5Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil5Charging_DIRECT(); } else { coil5Charging_MC33810(); } tachoOutputFlag = READY; }
...
inline void beginCoil6Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil6Charging_DIRECT(); } else { coil6Charging_MC33810(); } tachoOutputFlag = READY; }
...
inline void beginCoil7Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil7Charging_DIRECT(); } else { coil7Charging_MC33810(); } tachoOutputFlag = READY; }
...
inline void beginCoil8Charge() {if(ignitionOutputControl != OUTPUT_CONTROL_MC33810) {readKnock(); coil8Charging_DIRECT(); } else { coil8Charging_MC33810(); } tachoOutputFlag = READY; }
